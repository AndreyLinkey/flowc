...
namespace std
{
    ...
    std::error_code make_error_code(sqlite_orm::orm_error_code errorCode) {
    ...
    namespace internal {
        ...
        struct database_connection {
            ...
            database_connection(const std::string &filename) {
                auto rc = sqlite3_open_v2(filename.c_str(), &this->db, SQLITE_OPEN_READWRITE | SQLITE_OPEN_NOMUTEX, 0);
                if(rc != SQLITE_OK){
